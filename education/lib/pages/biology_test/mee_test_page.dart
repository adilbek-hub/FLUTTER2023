          ...
          children: [
            ...
            Expanded(
              ...
              child: Padding(
                ...
                child: Image.asset(
                    'assets/images/informatica/computerdik_tarmaktar/${widget.mee[indexmee].image}.jpg'),
              ),
            ),
            Expanded(
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        if (indexmee + 1 == widget.mee.length) {
                          showDialog<String>(
                            context: context,
                          ...
                          if (widget.mee[indexmee].jooptor[index].tuuraJoop ==
                              true) {
                            tuuraJooptor++;
                          } else {
                            kataJooptor++;
                      ...
                      child: Center(
                        child: AutoSizeText(
                          mee[indexmee].jooptor[index].name,
                          textAlign: TextAlign.center,
                          maxLines: 5,
                        ),
                      ),
