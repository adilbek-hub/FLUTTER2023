      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Center(
              child: Text(
                widget.adamJanybar[indexadamJanybar].name,
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        if (indexadamJanybar + 1 == widget.adamJanybar.length) {
                          showDialog<String>(
                            context: context,
                          ...
                          if (widget.adamJanybar[indexadamJanybar]
                      ...
                      child: Center(
                        child: AutoSizeText(
                          adamJanybar[indexadamJanybar].jooptor[index].name,
                          textAlign: TextAlign.center,
                          maxLines: 5,
                        ),
                      ),
