...
class AsiaTestPage extends StatefulWidget {
  const AsiaTestPage({
    super.key,
    required this.asiaSuroo,
  });
  final List<AsiaSuroo> asiaSuroo;
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            if (indexAsia + 1 ==
                              ...
                              if (state.testTopicsModel[0].geography[0]
                                      .asia[indexAsia].options[index].correct ==
                                  true) {
                                tuuraJooptor++;
                              } else {
                                kataJooptor++;
