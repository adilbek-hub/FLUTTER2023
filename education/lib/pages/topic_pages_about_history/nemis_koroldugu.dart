...
class NemisKoroldugu extends StatelessWidget {
  const NemisKoroldugu({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 5),
                const Text(
                  'Германиянын королдугу (Германия деп да аталат) ар кайсы мезгилде Европанын тарыхында маанилүү роль ойногон. 5-10-кылымдардын шартында Германия королдугу жөнүндө бирдиктүү жана борборлоштурулган мамлекет катары айтуу бир аз кыйын. Анын ордуна, ар кандай герман уруулары жана варвар уруулары азыркы Германияны жана коңшу аймактарды ээлеп турган мезгил болгон.',
